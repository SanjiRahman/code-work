...
//   } else {
//     error_log('Could not insert in to database');
//   }
...
<body class="bg-gray-800 text-white">
  ...
  <div class="text-black">
    <div class="popup">
      ...
      <form method="POST" action="DSR.php">
        <div class="form">
          <h2>Add DSR</h2>
          ...
          <div class="form-element">
            ...
            <input type="text" id="address" placeholder="Enter Location" required>
          </div>
          <div class="form-element">
          ...
          <div class="form-element">
            ...
            <input type="text" id="orders" placeholder="Enter Number Of Orders Delivered" required>
          </div>
          <div class="form-element">
            <label for="products">Products</label>
            <input type="text" id="products" placeholder="Enter Products" required>
          </div>
